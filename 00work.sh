...
8. for i in "ALL" "CG" "CHG" "CHH";do perl ./script/K_Fold_Cross_Validation.Extract-v1.0.pl -groupInfo 02TenFoldCV/BLCA-SGYY.Training.Healthy_Primary.txt -matrix ./BLCA-SGYY.RRBS.$i.matrix.csv.gz -kfold 10 -seed 100 -outdir 02TenFoldCV/$i;done
...
8. for i in "ALL" "CG" "CHG" "CHH";do perl ./script/K_Fold_Cross_Validation.Extract-v1.0.pl -groupInfo 04TenFoldCV/BLCA-SGYY.Training.Healthy_Primary.txt -matrix ./BLCA-SGYY.RRBS.$i.matrix.csv.gz -kfold 10 -seed 100 -outdir 04TenFoldCV/$i;done
