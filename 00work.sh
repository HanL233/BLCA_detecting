...
3. cat cytosine_report.list | perl -wlane 'next if (/^#/); print "perl ./RRBS/Advanced_Analysis/D-score/Arctangent_unMethylation.pl $F[5] ./RRBS/Advanced_Analysis/D-score/probe.sorted.merge.fixedBin_500bp.bed ./RRBS/Advanced_Analysis/D-score/01Arctangent $F[0]"' > Arctangent_unMethylation.sh
